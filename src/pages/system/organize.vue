<template>
  <div>
    <div class="head">
      ...
      <el-button type="success" icon="el-icon-plus" circle @click="add('添加组织')"></el-button>
    ...
    <div class="table">
      <el-table border :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="hlevel" label="上级"></el-table-column>
        <el-table-column label="操作" fixed="right" width="150">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" @click="mod('修改组织')">编辑</el-button>
